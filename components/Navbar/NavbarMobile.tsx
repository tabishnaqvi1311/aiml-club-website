  ...
  return (
    <>
      ...
      <div className='block sm:hidden'>
        ...
        {toggle && <>
          <div className='flex flex-col gap-5 text-lg bg-slate-100 p-7 text-gray-700 font-semibold items-center rounded-xl absolute top-20 right-10 z-30'>
            <Link href={"/events"} onClick={() => setToggle(prev => !prev)}>Events</Link>
            <Link href={"/members"} onClick={() => setToggle(prev => !prev)}>Members</Link>
            <Link href={"/projects"} onClick={() => setToggle(prev => !prev)}>Projects</Link>
